<?php
$base_url = 'http://localhost/platform.pdsionline.org/';
$config = [
	'base_url' => $base_url
...
*/
$check_field = 'id_user_input';
if (key_exists('user', $_SESSION)) {
	if ($_SESSION['user']['type'] == 'siswa') {
		$check_field = $_SESSION['user']['user_siswa_setting']['login_column'];
	}
}
$check_role_action = ['enable_global' => true, 'field' => $check_field];